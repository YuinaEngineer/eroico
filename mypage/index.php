...
<body>
  ...
  <div style="height:73.63px;"></div>
    ...
    switch (strtolower($_SERVER['REQUEST_METHOD']) . ':' . $paths[0]) {
      case 'get:':
        require_once $_SERVER['DOCUMENT_ROOT'].'/components/mypage/profile.php';
        break;
      case 'get:posted':
        $nukeruvideo->added_avs($_SESSION['id']);
        break;
      case 'get:like':
        $nukeruvideo->mylist_avs($_SESSION['id']);
        break;
      case 'get:nuketa':
        $nukeruvideo->nuketa_avs($_SESSION['id']);
        break;
      case 'get:history':
        $nukeruvideo->history_avs($_SESSION['id']);
        break;
      case 'get:follow':
        require_once $_SERVER['DOCUMENT_ROOT'].'/components/mypage/follow.php';
        break;
      case 'get:follower':
        require_once $_SERVER['DOCUMENT_ROOT'].'/components/mypage/follower.php';
        break;
    }
    ?>
    </div>
